...
@section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Appointment Add</div>
            </div>
            <div class="ibox-body">
                <form class="form-horizontal" id="form-appoint-add" method="post" novalidate="novalidate" action="{{route('admin.appointment.add')}}" accept-charset="utf-8">
                    @csrf
